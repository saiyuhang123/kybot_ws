...
| `kybot_brain` | ament_python | LLM (Qwen) task scheduler: `/brain_text` → function calling → stepwise sync tools (nav/grasp/photo/place) over mission & `/yolo_grasp/*` services (add-on, launched separately) |
